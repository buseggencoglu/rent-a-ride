...
urlpatterns = [
    ...
    path('my_reservations/', views.view_my_reservation_cardealer, name='cardealer_reservations'),
    path('my_reservations/', views.view_my_reservation_customer, name='customer_reservations'),
